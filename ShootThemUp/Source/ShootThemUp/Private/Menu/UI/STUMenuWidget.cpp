...
void USTUMenuWidget::InitLevelItems()
{
    ...
    checkf(STUGameInstance->GetLevelsData().Num() != 0, TEXT("Levels data must not be empty!")); //массив уровней не должен быть пустым
...
void USTUMenuWidget::OnStartGame()
{
    ...
    UGameplayStatics::PlaySound2D(GetWorld(), StartGameSound); //проигрывание музыки в меню
}
...
{
    UKismetSystemLibrary::QuitGame(this, GetOwningPlayer(), EQuitPreference::Quit, true);//Выход из игры
}
