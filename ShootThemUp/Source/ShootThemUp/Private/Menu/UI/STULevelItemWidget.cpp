...
void USTULevelItemWidget::SetSelected(bool IsSelected)//затеняем картинку уровня при выборе
{
    if (LevelImage)
    {
...
void USTULevelItemWidget::OnLevelItemHovered() //при наведении на кнопку
{
    if (FrameImage)
    {
